...
public class Paolo1Test extends TestCase {
    ...
    public void testAsnToDot1() throws java.io.FileNotFoundException,  java.io.IOException, JAXBException, Throwable {
        asnToDot("../VDM/src/test/resources/prov/provExample.prov",
                 "../VDM/target/provExample.prov-xml",
                 "../VDM/target/provExample.dot",
                 "../VDM/target/provExample.pdf");
    }
}
